...
let ModList = (_class = class ModList {
    constructor() {
        ...
        _initDefineProp(this, 'nextModId', _descriptor2, this);

        _initDefineProp(this, 'id', _descriptor3, this);

        _initDefineProp(this, 'name', _descriptor4, this);

        _initDefineProp(this, 'gameVersion', _descriptor5, this);
    }
...
}), _descriptor2 = _applyDecoratedDescriptor(_class.prototype, 'nextModId', [_mobx.observable], {
    enumerable: true,
    initializer: function () {
        return 0;
    }
}), _descriptor3 = _applyDecoratedDescriptor(_class.prototype, 'id', [_mobx.observable], {
    enumerable: true,
    initializer: function () {
        return 0;
    }
...
}), _descriptor5 = _applyDecoratedDescriptor(_class.prototype, 'gameVersion', [_mobx.observable], {
    enumerable: true,
    initializer: function () {
        return "0.0.0";
    }
